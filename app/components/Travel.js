    ...
    useEffect(() => {
        try {
            ...
            async function fetchData() {
                const { data } = await axios.get(`https://api.unsplash.com/search/photos?client_id=Xo1JuuXtZeFM3ke9eGQ1EoI7AV8PwnNUVE_WaVPmyqI&query=travel&page=${load}`)
                console.log(data);
    ...
    return (
        <div>
              <div className='poster'>
                <img src='https://source.unsplash.com/600x900/?travel'></img>
                <div className='content'>
                    <h1>Travels</h1>
                    <p>Discover hidden wonders and inspiring destinations around the world from the comfort of your own home.
..</p>
